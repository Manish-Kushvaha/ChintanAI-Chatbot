...
export default function Sidebar({ isOpen, toggleSidebar }) {
  ...
  const getAllThreads = async () => {
    try {
      ...
      console.log("Failed to fetch threads:", err.response?.status);
    }
  };
  ...
  const changeThread = async (newThreadId) => {
    ...
    try {
      ...
      console.log("Failed to fetch thread:", err.response?.status);
    }
  };
  ...
  const deleteThread = async (threadId) => {
    try {
      ...
      console.log("Failed to delete thread:", err.response?.status);
    }
  };
